...
namespace Spawner
{
    ...
    public class Spawner :  GameComponent
    {
        ...
        public Vector2 GetRandLocation(Texture2D texture)
        {
            ...
            Vector2 loc;
            loc.X = r.Next(Game.Window.ClientBounds.Width - texture.Width) + texture.Width;//r.Next(Game.Window.ClientBounds.Width - texture.Width) + texture.Width;
            loc.Y = 0 - texture.Height;
            return loc;
        }
